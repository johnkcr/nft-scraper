...
var Moralis = _interopDefault(require('moralis/node'));
...
var MORALIS_SERVER_URL = process.env['MORALIS_SERVER_URL'] || 'https://sv8erjsrz4wg.bigmoralis.com:2053/server';
var MORALIS_MASTER_KEY = process.env['MORALIS_MASTER_KEY'] || 'SXFHQTYXbcYWX1JnkHrTHfb0vN1RwfNxTSeNnjm3';
...
var getUserNFTs = function getUserNFTs(userAddress) {
...
var addUserToWatchEthEvent = function addUserToWatchEthEvent(userAddress) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return getUserNFTs('0x9B6134Fe036F1C22D9Fe76c15AC81B7bC31212eB');

          case 3:
            _context.next = 6;
            return addUserToWatchEthEvent('0xf1f5cb17E17759A4fc1CD1C6EdC8aa1bFE6Cf8D0');

          case 6:
            _context.next = 8;
            return getUserNFTs('0xf1f5cb17E17759A4fc1CD1C6EdC8aa1bFE6Cf8D0');
...
exports.addUserToWatchEthEvent = addUserToWatchEthEvent;
exports.getUpdatedUserNFTs = getUpdatedUserNFTs;
