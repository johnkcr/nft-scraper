...
var AccountApiFetchParamCreator = function AccountApiFetchParamCreator(configuration) {
  return {
    ...
    getHistoricalNFTTransfers: function getHistoricalNFTTransfers(address, chain, subdomain, providerUrl, fromBlock, toBlock, offset, limit, options) {
      ...
      var localVarUrlObj = parse(localVarPath, true);
     ...
     * @throws {RequiredError}
     */
    getNFTTransfers: function getNFTTransfers(address, chain, format$1, direction, offset, limit, order, options) {
      if (options === void 0) {
        options = {};
      }
      ...
      if (format$1 !== undefined) {
        localVarQueryParameter['format'] = format$1;
      }
     ...
     * @throws {RequiredError}
     */
    getNFTs: function getNFTs(address, chain, format$1, offset, limit, order, options) {
      if (options === void 0) {
        options = {};
      }
     ...
     * @throws {RequiredError}
     */
    getNFTsForContract: function getNFTsForContract(address, tokenAddress, chain, format$1, offset, limit, order, options) {
      if (options === void 0) {
        options = {};
      }
